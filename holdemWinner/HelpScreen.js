class HelpScreen {
	...
	constructor(screenWidth, screenHeight) {
		...
		this.bottomButton = new Button('Next', 0, 0, 0, 0,  0, 0, this.buttonColor, this.buttonHoverColor, null);
	...
	resize(screenWidth, screenHeight) {
		...
		let buttonHeight = 0.07 * this.menuHeight;
